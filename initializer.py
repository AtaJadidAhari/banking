...
class Person():
    ...
    def __init__(self, id, age, gender, married, divorced, childnum, marriage_age, religion, education, income, spouse, \
                 parent1, parent2, family_number, first_birth_age, relation, work_hour, age_radius_SN, IE,
                 last_child_birth, ostan):
        self.id = id
        self.age = age
        self.gender = gender
...
with open('./Data/InitialSettings3.txt', 'r') as f:
    for line in f:
        ...
        people.append(Person(V_ID, V_Age, V_Gender, married, divorced, V_childnum, marriage_age, religion, education, \
                             income, V_spouse, p1, p2, fn, first_birth_age, V_Relation, work_hour, age_radius_SN, IE,
                             last_child_birth, V_Ostan))
